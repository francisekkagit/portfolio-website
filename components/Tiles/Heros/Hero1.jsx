...
const Hero1 = () => {
  return (
      <div className='h-[50vh] bg-background_tile max-tile rounded-xl shadow-lg flex flex-col sm:flex-row justify-center items-center overflow-hidden animate-slide-up'>
        <div className='flex flex-col gap-3 p-7 justify-center items-center text-center h-[45%] sm:h-full sm:w-[60%] leading-none RedHat overflow-hidden fullHeightSmall'>
          ...
          <span className='text-[18px] min-[500px]:text-[20px] font-extralight transition-all duration-150'>Located in Danville, CA | <span className='italic text-warning'>Under Construction</span></span>
        </div>
