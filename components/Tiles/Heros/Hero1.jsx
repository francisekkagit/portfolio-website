  ...
  return (
    <div className='h-[50vh] flex justify-center items-center p-3 sm:p-6 md:p-10 transition-all duration-300'>
      <div className='bg-background_tile max-tile h-full rounded-xl shadow-lg flex flex-col sm:flex-row justify-center items-center overflow-hidden'>
        <div className='flex flex-col gap-3 p-7 justify-center items-center text-center h-[45%] sm:h-full sm:w-[50%] leading-none RedHat overflow-hidden'>
        ...
        <div className='w-full h-[50%] sm:w-[55%] sm:h-full flex justify-center items-center p-7 overflow-hidden max-h-500:hidden'>
