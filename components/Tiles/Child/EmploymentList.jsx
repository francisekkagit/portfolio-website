  ...
  return (
    <div className='flex flex-col w-full h-full justify-around gap-3 pb-3'>
        ...
        <div className='bg-subtile p-3 lg:p-5 flex flex-col gap-3 rounded-xl shadow-md leading-none'>
            ...
            <div className='flex flex-col gap-2 relative text-subtileText font-light'>
              <div className='flex gap-2'><div className='bulletPoint bg-current'/><span>Design, develop, and maintain an e-commerce application using <span className='font-normal'>Next.js, TailwindCSS, Node.js, and MongoDB</span> ensuring security and compliance with industry standards.</span></div>
              <div className='flex gap-2'><div className='bulletPoint bg-current'/><span>Build and manage multiple <span className='font-normal'>responsive MERN applications</span>.</span></div>
              <div className='flex gap-2'><div className='bulletPoint bg-current'/><span>Implement <span className='font-normal'>CI/CD pipelines using GitHub</span>, ensuring seamless updates and integrations.</span></div>
