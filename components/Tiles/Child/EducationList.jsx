...
const EducationList = () => {
    ...
    <div className='flex flex-col w-full md:h-full gap-3 md:gap-7 pb-3'>
        ...
        <div className='bg-subtile p-3 lg:p-5 flex flex-col gap-3 md:gap-5 rounded-xl shadow-md leading-none'>
        ...
        <div className='bg-subtile p-3 lg:p-5 flex flex-col gap-3 md:gap-5 rounded-xl shadow-md leading-none'>
            ...
            <div className='text-[14px] leading-none'><a href='https://aws.amazon.com/verification' className='flex gap-1 items-center justify-center text-blue-500 cursor-pointer'>
        ...
        <div className='bg-subtile p-3 lg:p-5 flex flex-col gap-3 md:gap-5 rounded-xl shadow-md leading-none'>
            ...
            <div className='text-[14px] leading-none'><a href='https://www.coursera.org/account/accomplishments/professional-cert/7MFYEEGDUM83' className='flex gap-1 items-center justify-center text-blue-500 cursor-pointer'>
                <span>Validate my certificate</span>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
                </svg>
