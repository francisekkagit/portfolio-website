        ...
        <div className='bg-subtile p-3 lg:p-5 flex flex-col gap-3 rounded-xl shadow-md leading-none'>
            <div className='flex items-center gap-2'>
                ...
                <div className='flex flex-col leading-0 justify-around gap-1'>
                    ...
                    <span className='text-subtileText font-light text-[14px]'>2018 - 2022</span>
                </div>
            </div>
            <div className='flex flex-col gap-2 text-subtileText font-light text-center'>
        ...
        <div className='bg-subtile p-3 lg:p-5 flex flex-col gap-3 rounded-xl shadow-md leading-none'>
            <div className='flex items-center gap-2'>
                ...
                <div className='flex flex-col leading-0 justify-around gap-1'>
                    ...
                    <span className='text-subtileText font-light text-[14px]'>April 2023</span>
                </div>
            </div>
            <div className='flex flex-col leading-none gap-2 text-subtileText font-light text-center'>
            ...
            <div className='flex justify-center'>
                <a href='https://aws.amazon.com/verification' className='flex gap-1 items-center justify-center text-blueLink  cursor-pointer text-[14px]'>
        ...
        <div className='bg-subtile p-3 lg:p-5 flex flex-col gap-3 rounded-xl shadow-md leading-none'>
            <div className='flex items-center gap-2'>
                ...
                <div className='flex flex-col leading-none justify-around gap-1'>
                    ...
                    <span className='text-subtileText font-light text-[14px]'>September 2024</span>
                </div>
            </div>
            <div className='flex flex-col leading-none gap-2 text-subtileText font-light text-center'>
            ...
            <div className='flex justify-center'>
                <a href='https://www.coursera.org/account/accomplishments/professional-cert/7MFYEEGDUM83' className='flex gap-1 items-center justify-center text-blueLink  cursor-pointer text-[14px]'>
                    <span>Validate my certificate</span>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
                    </svg>
