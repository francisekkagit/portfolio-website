  ...
  return (
    <div className='flex flex-col gap-3 p-3 sm:flex-row sm:gap-5 sm:p-5'>
        <div className='RedHat w-full sm:w-[50%] flex flex-col gap-3 p-3 sm:gap-5 sm:p-3 items-center justify-center text-center'>
            <p className='font-semibold text-[40px] textShadow'>Under Construction</p>
        ...
        <div className='RedHat border-1 border-border_tile bg-background_tile w-full sm:w-[50%] rounded-xl shadow-xl flex flex-col items-center gap-3 p-3 sm:gap-5 sm:p-5'>
            <img src='/component_imgs/francisProfile1.png' width={2979} height={2979} className='w-full max-w-[450px] rounded-full shadow-lg'/>

            <p className='textShadow text-[16px]'>Full Stack Developer in Danville, CA</p>

            <a className='flex gap-1 items-center hover:bg-background hover:shadow-md ease-in-out duration-150 p-2 rounded-xl' href="mailto: francisxekka@gmail.com">
